        ...
        <div class="max-w-[360px] mx-auto">
            <div class="bg-white shadow-lg rounded-lg mt-9">
                ...
                <header class="text-center px-5 pb-5">
                    ...
                    <div class="text-sm font-medium text-gray-500">Invoice #00224 {props.inv}</div>
                </header>
                <div class="bg-gray-100 text-center px-5 py-6">
                    ...
                    <form class="space-y-3">
                        ...
                        <button type="submit" class="font-semibold text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out w-full bg-indigo-500 hover:bg-indigo-600 text-white focus:outline-none focus-visible:ring-2">{props.btnText}</button>
                    </form>
                </div>
            </div>
        </div>
